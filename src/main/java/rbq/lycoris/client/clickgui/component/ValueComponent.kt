package rbq.lycoris.client.clickgui.component
...
import rbq.lycoris.client.utils.MathUtils
import rbq.lycoris.client.value.BooleanValue
import rbq.lycoris.client.value.ModeValue
import rbq.lycoris.client.value.NumberValue
...
class ValueListComponent(
    ...
    override fun render(mouseX: Int, mouseY: Int, partialTicks: Float) {
        rbq.lycoris.client.clickgui.utils.RenderUtil.startGlScissor(
            x.toInt() - 10,
            y.toInt() + 10,
            width.toInt() + 10,
            height.toInt() - 10
        ...
        rbq.lycoris.client.clickgui.utils.RenderUtil.stopGlScissor()
    }
}
...
class BooleanValueComponent(
    ...
    override fun render(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        if (value.get()) { //
            rbq.lycoris.client.clickgui.utils.RenderUtil.drawFilledCircle(
                (x + BUTTON_OFFSET_X + 1).toDouble(), (y + BUTTON_CIRCLE_OFFSET_Y).toDouble(), 6.0,
                Color(79, 66, 184).rgb, 5
            )
            rbq.lycoris.client.clickgui.utils.RenderUtil.drawRect(
...
class ModeValueComponent(
    ...
    override fun render(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        rbq.lycoris.client.clickgui.utils.RenderUtil.drawFastRoundedRect(
            x + BUTTON_OFFSET_X,
            y + BUTTON_OFFSET_Y,
            x + BUTTON_END_X,
            y + BUTTON_END_Y,
