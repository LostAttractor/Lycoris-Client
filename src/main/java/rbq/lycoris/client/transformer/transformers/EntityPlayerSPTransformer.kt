...
import rbq.lycoris.client.event.*
        ...
        for (method in classNode.methods) {
            if (method.name == EntityPlayerSP.onUpdateWalkingPlayer.name) {
                ...
                insnList.add(
                    FieldInsnNode(
                        Opcodes.GETSTATIC,
                        Type.getInternalName(EventState::class.java),
                        "PRE",
                        "L${Type.getInternalName(EventState::class.java)};"
                    )
                )
                ...
                insnList.add(
                    MethodInsnNode(
                        ...
                        Type.getInternalName(MotionEvent::class.java),
                        "<init>",
                        "(L${Type.getInternalName(EventState::class.java)};)V",
                        false
                    )
                )
            ...
            if (method.name == EntityPlayerSP.onLivingUpdate.name) {
                ...
                insnList.add(
                    MethodInsnNode(
                        Opcodes.INVOKESPECIAL,
                        Type.getInternalName(UpdateEvent::class.java),
                        "<init>",
                        "()V",
                        false
                    )
