package rbq.lycoris.client.wrapper.bridge;

import rbq.lycoris.agent.asm.*;
import rbq.lycoris.client.detector.MargeleAntiCheatDetector;
import rbq.lycoris.client.wrapper.impl.GuiScreenImpl;
import rbq.lycoris.client.wrapper.wrappers.gui.GuiChat;
import rbq.lycoris.client.wrapper.wrappers.gui.GuiScreen;
...
public class BridgeUtil {
    ...
    public static void init() {
        try {
            ...
            byte[] buf = buildGuiScreenBridge("rbq.lycoris.client.wrapper.bridge.accessor.GuiScreenBridge");
            GuiScreenBridge = (Class<?>) classloader.invoke(BridgeUtil.class.getClassLoader(), null, buf, 0, buf.length);

            buf = buildGuiChatBridge("rbq.lycoris.client.wrapper.bridge.accessor.GuiCommandReplace");
            ...
            if (MargeleAntiCheatDetector.isMAC()) {
                buf = buildMargeleAntiCheatAccessor("rbq.lycoris.client.wrapper.bridge.accessor.MargeleAntiCheatAccessor");
