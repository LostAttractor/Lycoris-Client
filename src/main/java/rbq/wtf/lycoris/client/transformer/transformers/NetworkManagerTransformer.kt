    ...
    override fun transform(bytes: ByteArray): ByteArray {
        ...
        for (method in classNode.methods) {
            if (method.name == NetworkManager.sendPacket.name) {
                ...
                insnList.add(MethodInsnNode(Opcodes.INVOKESPECIAL, Type.getInternalName(Packet::class.java), "<init>", "(Ljava/lang/Object;)V", false))
                // {this, Packet} | {uninitialized_PacketSendEvent, uninitialized_PacketSendEvent, PacketWrapper}
                insnList.add(MethodInsnNode(Opcodes.INVOKESPECIAL, Type.getInternalName(PacketSendEvent::class.java), "<init>", "(L${Type.getInternalName(Packet::class.java)};)V", false))
                ...
                insnList.add(MethodInsnNode(Opcodes.INVOKEVIRTUAL, Type.getInternalName(PacketSendEvent::class.java), "isCancelled", "()Z", false))
            ...
            if (method.name == NetworkManager.channelRead0.name) {
                ...
                insnList.add(MethodInsnNode(Opcodes.INVOKESPECIAL, Type.getInternalName(PacketReceiveEvent::class.java), "<init>", "(L${Type.getInternalName(Packet::class.java)};)V", false))
                ...
                insnList.add(MethodInsnNode(Opcodes.INVOKEVIRTUAL, Type.getInternalName(PacketReceiveEvent::class.java), "isCancelled", "()Z", false))
