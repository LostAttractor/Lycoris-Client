...
//		if(!Main.smoothfont.getState()){
//			//GL11.glPushMatrix();
//
//			//GL11.glScalef((float) font.getSize()*(1.0f/16.0f),(float) font.getSize()*(1.0f/16.0f),0);
//			//Main.mc.fontRendererObj.drawStringWithShadow(text,(float) x*font.getSize()*(1.0f/16.0f),(float)y*font.getSize()*(1.0f/16.0f),color);
//			//GL11.glPopMatrix();
//			Main.mc.fontRendererObj.drawStringWithShadow(text,(float) x,(float)y,color);
//			return 0.0f;
//		}
...
//			//GL11.glPushMatrix();
//			//GL11.glScalef((float) font.getSize()*(1.0f/16.0f),(float) font.getSize()*(1.0f/16.0f),0);
//			//Main.mc.fontRendererObj.drawString(text,(float) x*font.getSize()*(1.0f/16.0f),(float)y*font.getSize()*(1.0f/16.0f),color,shadow);
//		//	GL11.glPopMatrix();
//			Main.mc.fontRendererObj.drawString(text,(float) x,(float)y,color,shadow);
//			return 0.0f;
//		}
...
//		if(!Main.smoothfont.getState()){
//			return (int)((float)Main.mc.fontRendererObj.getStringWidth(text));
//		}
        if (text == null) {
            return 0;
        }
