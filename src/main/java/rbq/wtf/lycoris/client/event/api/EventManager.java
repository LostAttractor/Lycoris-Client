...
import  rbq.wtf.lycoris.client.event.api.events.EventStoppable;
...
public final class EventManager {
     ...
     * a new MethodData to key's matching list and sorts it based on Priority. @see  rbq.wtf.lycoris.client.event.api.types.Priority
