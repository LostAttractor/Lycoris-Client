...
public class AStarCustomPathFinder {
    ...
    private static boolean isBlockSolid(BlockPos block) {
        return Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())).getBlock().getMaterial(Minecraft.getMinecraft().world.getBlockState(block)).blocksMovement() ||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockSlab) ||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockStairs)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockCactus)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockChest)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockEnderChest)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockSkull)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockPane)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockFence)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockWall)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockGlass)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockPistonBase)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockPistonExtension)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockPistonMoving)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockStainedGlass)||
                (Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())) instanceof BlockTrapDoor);
    }

    private static boolean isSafeToWalkOn(BlockPos block) {
        return !(Minecraft.getMinecraft().world.getBlockState(new BlockPos(block.getX(), block.getY(), block.getZ())).getBlock() instanceof BlockFence) &&
