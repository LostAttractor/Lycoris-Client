...
//            setColor(color);
    ...
    public static int getTeamColor(Entity player) {
        ...
        if (player instanceof EntityPlayer) {
            ...
            if (var6 != null) {
                String var7 = FontRenderer.getFormatFromString(var6.getColor().toString());

                if (var7.length() >= 2) {
                    if (!"0123456789abcdef".contains(String.valueOf(var7.charAt(1))))
                        return var2;

                    var2 = mc.fontRenderer.getColorCode(var7.charAt(1));
                }
            }
        }
     ...
     * mc.player.getEyeHeight(), 0); GL11.glVertex3d(x, y,
