...
public class FontLoaders {
    public static CFontRenderer default15 = new CFontRenderer(new Font("default", Font.PLAIN, 15), true, true, false);
    public static CFontRenderer default16 = new CFontRenderer(new Font("default", Font.PLAIN, 16), true, true, false);
