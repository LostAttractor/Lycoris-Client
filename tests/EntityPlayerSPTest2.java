...
public class EntityPlayerSPTest2 extends Entity {
    ...
    public void onUpdateWalkingPlayer() {
        EventMotionUpdate event = new EventMotionUpdate(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround, EventMotionUpdate.Type.PRE);
